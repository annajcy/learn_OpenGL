...
float Perspective_camera::near_bound() const { return m_near_bound; }
float Perspective_camera::far_bound() const { return m_far_bound; }
float& Perspective_camera::fov() { return m_fov; }
float& Perspective_camera::aspect() { return m_aspect; }
float& Perspective_camera::near_bound() { return m_near_bound; }
float& Perspective_camera::far_bound() { return m_far_bound; }
