...
float Orthographic_camera::near_bound() const { return m_near_bound; }
float Orthographic_camera::far_bound() const { return m_far_bound; }
...
float& Orthographic_camera::near_bound() { return m_near_bound; }
float& Orthographic_camera::far_bound() { return m_far_bound; }
